...
Require Import SessionCleanNoRet2Sub.
...
Example incTwice : runProtoBigStep _ _ _ client proto2 (basic 3).
Proof.
  repeat econstructor.
Qed.
...
Example result1Gen : forall k k', multie (protoDecrypt1 k) (protoEncrypt1 k') (ReturnC (basic 42)) -> (k' = inverse k).
Proof.
  intros.
...
Example badResult1 : forall k k', (k <> inverse k') -> multie (protoDecrypt1 k) (protoEncrypt1 k') (ReturnC (bad Basic)).
Proof.
  intros.
  eapply multi_step. constructor. constructor.
